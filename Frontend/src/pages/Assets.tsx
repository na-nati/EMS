...
export default function AssetsDashboard() {
  ...
  const filteredAssignments = initialRecentAssignments.filter((assignment) => {
  ...
  const handleAddAsset = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    console.log("Adding new asset (inline form)...");
    ...
    <div className="space-y-8 p-6 bg-background min-h-screen text-foreground font-inter">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-2">Track and manage company assets and equipment</p>
        </div>
      ...
      {/* Asset Search and Filters & Recent Assignments */}
      <div className="bg-card p-6 rounded-xl border border-border shadow-sm">
        <h3 className="text-lg font-semibold text-foreground mb-4">Asset Assignments</h3>
        ...
        <div className="space-y-4">
          <h4 className="text-md font-medium text-foreground">Recent Assignments</h4>
            ...
            filteredAssignments.map((assignment, index) => (
              <div key={index} className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 bg-muted/30 rounded-lg border border-border/50">
                <div className="flex items-start sm:items-center space-x-4 mb-3 sm:mb-0 w-full sm:w-auto">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-foreground">{assignment.employee} <span className="text-xs text-muted-foreground">({assignment.department})</span></p>
      ...
      {/* Grid Layout for Maintenance Alerts and Asset Requests (rest of your component) */}
