...
router.get('/', (0, authMiddleware_1.authorizeRoles)('super_admin', 'hr'), assetController_1.getAllAssets);
router.get('/:id', (0, authMiddleware_1.authorizeRoles)('super_admin', 'hr'), assetController_1.getAssetById);
...
router.get('/employee/:employeeId', (0, authMiddleware_1.authorizeRoles)('super_admin', 'hr', 'employee'), assetController_1.getAssetsByEmployee);
