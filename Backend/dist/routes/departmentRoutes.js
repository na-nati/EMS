...
router.get('/', authMiddleware_1.authMiddleware, (0, authMiddleware_1.authorizeRoles)('super_admin', 'hr', 'manager'), departmentController_1.getDepartments);
router.get('/:id', authMiddleware_1.authMiddleware, (0, authMiddleware_1.authorizeRoles)('super_admin', 'hr', 'manager'), departmentController_1.getDepartmentById);
